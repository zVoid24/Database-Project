...
CREATE TABLE `complain` (
  ...
  KEY `bus_id` (`bus_id`),
  CONSTRAINT `complain_ibfk_1` FOREIGN KEY (`passenger_id`) REFERENCES `passenger` (`passenger_id`),
  CONSTRAINT `complain_ibfk_2` FOREIGN KEY (`bus_id`) REFERENCES `bus` (`bus_id`)
...
INSERT INTO `complain` VALUES (1,1,1,'valo na'),(2,1,1,'Seat Vanga'),(3,1,1,'Bad service'),(4,1,1,'bad service');
...
-- Dump completed on 2025-03-08 23:24:30
