...
CREATE TABLE `busroute` (
  ...
  PRIMARY KEY (`bus_id`),
  CONSTRAINT `busroute_ibfk_1` FOREIGN KEY (`bus_id`) REFERENCES `bus` (`bus_id`)
...
INSERT INTO `busroute` VALUES (1,'A384'),(2,'A354'),(3,'A110'),(4,'A101'),(5,'A110'),(6,'A122'),(8,'A182'),(9,'A202'),(10,'A207'),(11,'A225'),(12,'A230'),(13,'A234'),(14,'A240'),(15,'A245'),(16,'A256'),(17,'A257'),(18,'A264'),(19,'A266'),(20,'A319'),(21,'A344'),(22,'A354'),(23,'A384');
...
-- Dump completed on 2025-03-08 23:24:42
