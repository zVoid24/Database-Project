...
--
-- Table structure for table `A266`
--

DROP TABLE IF EXISTS `A266`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `A266` (
  `route_id` varchar(30) NOT NULL,
  `JagannathUniversity` int NOT NULL,
...
--
-- Dumping data for table `A266`
--

LOCK TABLES `A266` WRITE;
/*!40000 ALTER TABLE `A266` DISABLE KEYS */;
INSERT INTO `A266` VALUES ('A266',0,2,3,9,11,18,50);
/*!40000 ALTER TABLE `A266` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-08 23:24:14
