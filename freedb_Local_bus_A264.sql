...
--
-- Table structure for table `A264`
--

DROP TABLE IF EXISTS `A264`;
...
CREATE TABLE `A264` (
  ...
  `Fulbaria` int NOT NULL,
  `NayaBazar` int NOT NULL,
  `Keraniganj` int NOT NULL,
  PRIMARY KEY (`route_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `A264`
--

LOCK TABLES `A264` WRITE;
/*!40000 ALTER TABLE `A264` DISABLE KEYS */;
INSERT INTO `A264` VALUES ('A264',0,2,3,9,14,16,17);
/*!40000 ALTER TABLE `A264` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-08 23:24:19
