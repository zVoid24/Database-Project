...
--
-- Table structure for table `A101`
--

DROP TABLE IF EXISTS `A101`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `A101` (
  `route_id` varchar(30) NOT NULL,
  `Kalshi` int NOT NULL,
  `Mirpur12` int NOT NULL,
  `Mirpur10` int NOT NULL,
  `Kazipara` int NOT NULL,
  `Shewrapara` int NOT NULL,
  `Farmgate` int NOT NULL,
  `Shahbagh` int NOT NULL,
  `Paltan` int NOT NULL,
  `Gulistan` int NOT NULL,
  `Tikatuli` int NOT NULL,
  `Sayedabad` int NOT NULL,
  `Jatrabari` int NOT NULL,
  `Signboard` int NOT NULL,
  `KachpurBridge` int NOT NULL,
  PRIMARY KEY (`route_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `A101`
--

LOCK TABLES `A101` WRITE;
/*!40000 ALTER TABLE `A101` DISABLE KEYS */;
INSERT INTO `A101` VALUES ('A101',0,2,5,6,7,11,14,16,17,18,19,20,25,29);
/*!40000 ALTER TABLE `A101` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-08 23:24:03
