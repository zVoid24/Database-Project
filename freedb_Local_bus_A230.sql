...
--
-- Table structure for table `A230`
--

DROP TABLE IF EXISTS `A230`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `A230` (
  `route_id` varchar(30) NOT NULL,
  `Adamjee` int NOT NULL,
  `Demra` int NOT NULL,
...
--
-- Dumping data for table `A230`
--

LOCK TABLES `A230` WRITE;
/*!40000 ALTER TABLE `A230` DISABLE KEYS */;
INSERT INTO `A230` VALUES ('A230',0,9,16);
/*!40000 ALTER TABLE `A230` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-08 23:24:29
