...
--
-- Table structure for table `A202`
--

DROP TABLE IF EXISTS `A202`;
...
--
-- Dumping data for table `A202`
--

LOCK TABLES `A202` WRITE;
/*!40000 ALTER TABLE `A202` DISABLE KEYS */;
INSERT INTO `A202` VALUES ('A202',0,14,17,19,26,29,43);
/*!40000 ALTER TABLE `A202` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-08 23:24:08
