...
--
-- Table structure for table `A319`
--
...
CREATE TABLE `A319` (
  ...
  `Kalapani` int NOT NULL,
  `BangabandhuCollege` int NOT NULL,
  `Mirpur11` int NOT NULL,
...
--
-- Dumping data for table `A319`
--

LOCK TABLES `A319` WRITE;
/*!40000 ALTER TABLE `A319` DISABLE KEYS */;
INSERT INTO `A319` VALUES ('A319',0,1,2,5,6,7,12,17,20,21,31);
/*!40000 ALTER TABLE `A319` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-08 23:24:09
