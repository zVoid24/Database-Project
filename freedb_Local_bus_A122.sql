...
--
-- Table structure for table `A122`
--

DROP TABLE IF EXISTS `A122`;
...
CREATE TABLE `A122` (
  ...
  `ShishuMela` int NOT NULL,
  `CollegeGate` int NOT NULL,
...
--
-- Dumping data for table `A122`
--

LOCK TABLES `A122` WRITE;
/*!40000 ALTER TABLE `A122` DISABLE KEYS */;
INSERT INTO `A122` VALUES ('A122',0,5,9,10,11,13,14,15,16,22);
/*!40000 ALTER TABLE `A122` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-08 23:24:24
