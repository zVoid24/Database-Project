...
CREATE TABLE `helper` (
  ...
  `helper_pass` varchar(128) NOT NULL,
  PRIMARY KEY (`helper_id`),
  KEY `bus_id` (`bus_id`),
  CONSTRAINT `helper_ibfk_1` FOREIGN KEY (`bus_id`) REFERENCES `bus` (`bus_id`)
...
INSERT INTO `helper` VALUES (1,1,'DH005','ec808c7d1909445b750da606e5247d079baf5ab3daf8c4eb0266a77bb5256b151e6e880696fda5f356904ecf337b843c4c19d23cd583a43d731f5adc6c58945e');
...
-- Dump completed on 2025-03-08 23:24:25
